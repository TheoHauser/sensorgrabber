...
PATH_NAME = "/home/sam/SensorGrabber/Data/"
#FILE_NAME = "07-06-2015 20:40:32.csv"
...
def write_to_file(arrayOne, arrayTwo):
	...
	np.savetxt("ass.csv", (arrayOne, arrayTwo), fmt="%s")
...
np.savetxt(str(PATH_NAME + "_FILTERED_" + file_name), np.transpose([data['time'], s_v_y]), fmt="%s")
